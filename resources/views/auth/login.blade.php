...
<head>
    ...
    <meta name="description" content="@yield('description', 'Connect to AMC SARL to manage employees, clients, invoices, and more.')"/>
    <meta name="keywords" content="AMC SARL, employee management, client management, invoices, HR, business management"/>


    <meta property="og:type" content="website"/>
    <meta property="og:title" content="@yield('og:title', 'AMC SARL')"/>
    <meta property="og:description" content="@yield('og:description', 'Connect to AMC SARL to manage employees, clients, invoices, and more.')"/>
    <meta property="og:image" content="@yield('og:image', asset('logo/img.png'))"/>
    <meta property="og:url" content="{{ url()->current() }}"/>
    <meta property="og:site_name" content="AMC SARL"/>


    <meta name="twitter:card" content="summary_large_image"/>
    <meta name="twitter:title" content="@yield('twitter:title', 'AMC SARL | Login')"/>
    <meta name="twitter:description" content="@yield('twitter:description', 'Connect to AMC SARL to manage employees, clients, invoices, and more.')"/>
    <meta name="twitter:image" content="@yield('twitter:image', asset('logo/img.png'))"/>
    <meta name="twitter:site" content="@AMCSARL"/>
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <div class="login-logo d-flex justify-content-center align-items-center mb-3">
                <img src="{{ asset('logo/logo.png') }}" alt="AMC SARL Logo" class="me-2" style="height:80px; width:auto;">
                <span class="fs-4 fw-bold">AMC SARL</span>
            </div>
