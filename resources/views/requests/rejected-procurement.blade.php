...
@section('content')
                    ...
                    <div class="request-table-wrapper">
                        ...
                        >
                            ...
                            {{-- =================================================
                                 ...
                                 IMPORTANT:
                                 Pas de <tr colspan="8"> dans le tbody.

                                 Si aucune demande n'existe, le tbody
                            ...
                            @foreach($requests as $request)
                                ...
                                <tr>
                                    ...
                                    <td
                                        data-order="{{ $request->rejected_at?->timestamp ?? 0 }}"
                                    >
    ...
    <style>
        ...
        #rejectedTable_wrapper .dataTables_empty {
            ...
            document.addEventListener(
                ...
                function () {
                    ...
                    $('#rejectedTable').DataTable({
                        ...
                        /*
                         * Tri par Rejected Date.
                         *
                         * Colonne 6 = Rejected Date.
                         */
                        order: [
