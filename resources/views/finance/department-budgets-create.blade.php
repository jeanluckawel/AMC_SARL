...
@section('title', 'Create Department Budget - Finance')
...
@section('content')
    ...
    <div class="app-content">
        ...
        <div class="container-fluid">
            ...
            <div class="card budget-card budget-card-wrapper m-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('finance.department-budgets.store') }}"
                        method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <small class="text-muted">
                                    Initially equal to the budget amount.
                                </small>
