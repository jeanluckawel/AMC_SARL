...
@section('content')
    ...
    <style>
        ...
        #ceoRejectedTable th:nth-child(1),
        #ceoRejectedTable td:nth-child(1) {
            width: 45px;
        }

        #ceoRejectedTable th:nth-child(2),
        #ceoRejectedTable td:nth-child(2) {
            width: 130px;
        }

        #ceoRejectedTable th:nth-child(3),
        #ceoRejectedTable td:nth-child(3) {
            width: 22%;
        }

        #ceoRejectedTable th:nth-child(4),
        #ceoRejectedTable td:nth-child(4) {
            width: 17%;
        }

        #ceoRejectedTable th:nth-child(5),
        #ceoRejectedTable td:nth-child(5) {
            width: 65px;
        }

        #ceoRejectedTable th:nth-child(6),
        #ceoRejectedTable td:nth-child(6) {
            width: 125px;
        }

        #ceoRejectedTable th:nth-child(7),
        #ceoRejectedTable td:nth-child(7) {
            width: 145px;
        }

        #ceoRejectedTable th:nth-child(8),
        #ceoRejectedTable td:nth-child(8) {
            width: 80px;
        }
        ...
        #ceoRejectedTable_wrapper .dataTables_empty {
                ...
                function () {
                    ...
                    $('#ceoRejectedTable').DataTable({
                        ...
                        language: {
                            ...
                            emptyTable:
                                'No CEO rejected requests found',
